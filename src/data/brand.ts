  ...
  leadership: [
    {
      ...
      bio: "Founding leader driving the strategic vision, operational discipline, and growth of JSM Integrated Services from its roots as JSMMANPOWER into Tamil Nadu's premier integrated workforce partner."
    },
    {
      name: "Jan Steve Daniel R",
      role: "Chief Technology Officer",
      bio: "Leading technology-enabled operations, digital attendance systems, SOP automation, and client reporting platforms."
    },
    {
      name: "Richard A",
      role: "Head of Operations",
      bio: "Overseeing field deployments, supervisory spot-checks, client escalation protocols, and compliance adherence."
    }
  ],
